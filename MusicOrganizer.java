...
public class MusicOrganizer
{
     ...
     * @param dir The directory containing the audio files.
     */
    public MusicOrganizer(File dir)
    {
    ...
    public void readLibrary(File dir)
    {
        ArrayList<Track> tempTracks = reader.readTracks(dir, ".mp3");
